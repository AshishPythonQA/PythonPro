...
class chapter1Screen:
    def Chapter1(self, url):
        ...
        try:
            ...
            time.sleep(1)
            excel.writeData("Chapter1_Data", "D2", "PASS")
            driver.close()

        except Exception as e:
            excel.writeData("Chapter1_Data", "D2", "FAIL")
            time.sleep(1)
            excel.writeData("Chapter1_Data", "E2", str(e))
